export const ticketsCopy = {
  ...
  offline: {
    ...
    sharedToast: 'Ingresso compartilhado.',
    printedToast: 'Use a caixa de diálogo do navegador para salvar como PDF.',
    exportPermissionDenied: 'Permissão negada. Autorize o acesso à galeria nas configurações.',
    exportError: 'Não foi possível exportar o ingresso. Tente novamente.',
