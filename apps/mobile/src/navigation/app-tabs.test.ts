...
// ./app-tabs pulls in ~/api/client, which imports react-native directly (for
// the x-ccc-platform header), whose Flow-flavored `import typeof` syntax
// vitest's SSR transform cannot parse. Mock it before importing.
