  ...
  await prisma.badge.createMany({
    data: [
      ...
      },
      {
        ...
        rarity: 'common',
        icon: 'post',
        title: 'Conquista COM-001',
        description: 'Descrição de COM-001',
      },
      {
        code: 'CCC-001',
        category: 'ccc',
        rarity: 'common',
        icon: 'pin',
        title: 'Conquista CCC-001',
        description: 'Descrição de CCC-001',
      },
      {
        code: 'CCC-002',
        category: 'ccc',
        rarity: 'rare',
        icon: 'flagCheck',
        title: 'Conquista CCC-002',
        description: 'Descrição de CCC-002',
      },
      {
        code: 'CCC-003',
        category: 'ccc',
        ...
        title: 'Conquista CCC-003',
        description: 'Descrição de CCC-003',
      },
    ],
  });
};
